 ...
 *      picker form).
 *   3. State key `dkan_ai_query_mock.active_scenario` (site-wide active
...
final class ScenarioMatcher {
  ...
  public const STATE_KEY = 'dkan_ai_query_mock.active_scenario';
   ...
   *
   * @return \Drupal\dkan_ai_query_mock\Scenario|null
