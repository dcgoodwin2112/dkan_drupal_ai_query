...
class ScenarioLoader {
  ...
  private const CACHE_KEY = 'dkan_drupal_ai_query_mock:scenarios';

  /**
   * In-process snapshot of discovered scenarios, keyed by id.
   *
   * @var array<string, \Drupal\dkan_drupal_ai_query_mock\Scenario>|null
   */
   ...
   *
   * @return array<string, \Drupal\dkan_drupal_ai_query_mock\Scenario>
  ...
  public function all(): array {
    ...
    $this->cache->set(self::CACHE_KEY, $this->scenarios, CacheBackendInterface::CACHE_PERMANENT, ['dkan_drupal_ai_query_mock:scenarios']);
    return $this->scenarios;
  }
  ...
  private function discover(): array {
    $modulePath = $this->pathResolver->getPath('module', 'dkan_drupal_ai_query_mock');
    $directories = [
