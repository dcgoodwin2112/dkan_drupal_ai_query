...
class FixtureLoader {
  ...
  public const STATE_RESOURCE_ID = 'dkan_drupal_ai_query_mock.fixture_resource_id';
  ...
  public function __construct(
    ...
    $this->modulePath = $appRoot . '/' . $moduleExtensionList->getPath('dkan_drupal_ai_query_mock');
  }
