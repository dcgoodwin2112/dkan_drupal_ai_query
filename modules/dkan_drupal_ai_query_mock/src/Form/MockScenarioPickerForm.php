...
namespace Drupal\dkan_drupal_ai_query_mock\Form;
 ...
 *
 * Writes to State key `dkan_drupal_ai_query_mock.active_scenario`. Operators
...
class MockScenarioPickerForm extends FormBase {
  ...
  public static function create(ContainerInterface $container): static {
    return new static(
      $container->get('dkan_drupal_ai_query_mock.scenario_loader'),
      $container->get('state'),
    );
  }
  ...
  public function getFormId(): string {
    return 'dkan_drupal_ai_query_mock_scenario_picker';
  }
