...
/**
 * Tests StatsCalculator statistical operations.
 *
 * @group dkan_ai_query
 */
class StatsCalculatorTest extends TestCase {
  ...
  /**
   * Builds a fresh StatsCalculator.
   */
  ...
  /**
   * Wraps a flat value list into single-column rows.
   */
  ...
  /**
   * Median of an odd-length column picks the middle value.
   */
  ...
  /**
   * Median of an even-length column averages the middle pair.
   */
  ...
  /**
   * Percentiles interpolate linearly between ranks.
   */
  ...
  /**
   * An out-of-range p value yields the invalid_p error.
   */
  ...
  /**
   * Stddev uses the sample (n-1) formula, not population.
   */
  ...
  /**
   * Variance uses the sample formula.
   */
  ...
  /**
   * Stddev on a single row yields insufficient_rows.
   */
  ...
  /**
   * Quartiles return q1, q2, q3, and the IQR.
   */
  ...
  /**
   * A perfect linear relation correlates to 1.0.
   */
  ...
  /**
   * A perfect inverse relation correlates to -1.0.
   */
  ...
  /**
   * A constant column yields the zero_variance error.
   */
  ...
  /**
   * Correlation requires exactly two column names.
   */
  ...
  /**
   * Non-numeric rows are skipped and reported in the skipped count.
   */
  ...
  /**
   * A column with no numeric values yields no_numeric_values.
   */
  ...
  /**
   * A missing column name yields invalid_column.
   */
  ...
  /**
   * An unknown operation type yields unknown_operation.
   */
  ...
  /**
   * Multiple operations run in a single call.
   */
  ...
  /**
   * The output always carries the row_cap_hit warning.
   */
